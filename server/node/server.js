...
var fb = require('./services/api/connectFacebook');
var gmail = require('./services/api/connectGoogle');
var twitter = require('./services/api/connectTwitter');

var User = require('./services/database/mongo');
var userSchema = require('./services/database/mongo');
...
app.post('/auth/signup', function(req, res) {
	console.log('test1');
  User.User.findOne({ email: req.body.email }, function(err, existingUser) {
	  console.log('findOne');
    if (existingUser) {
...
/*
 ...
 |--------------------------------------------------------------------------
 */
app.post('/auth/google', gmail.connectGmail);
...
/*
 ...
 |--------------------------------------------------------------------------
 */
app.post('/auth/facebook', fb.connectFB);
...
/*
 ...
 |--------------------------------------------------------------------------
 */
app.post('/auth/twitter', twitter.connectTwitter);
